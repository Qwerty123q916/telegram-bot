...
region_photos = {
    "Toshkent": [
        ...
        "AgACAgIAAxkBAAP7ab3AcVlJ4sAlgkXCikxZYlZP3hwAAhYQaxt7svBJnDtuKqP22bEBAAMCAAN5AAM6BA",
        "AgACAgIAAxkBAAP9ab3AuboJy0Lj5lydTvbHqcERyaAAAhcQaxt7svBJcOvpIuau7E0BAAMCAAN5AAM6BA",
    ],
    "Samarqand": [
        "SAMARQAND_1_FILE_ID",
        "SAMARQAND_2_FILE_ID",
...
✅ Тўғри танлов қилинг!""",
        "2": " 🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋🦋
ЙЕНГИ ОЧИЛГАН СПА САЛОНДАН ЁЗ МАВСУМГА СУПЕР СКИТКА😍

 200-МИНГА 4- ХИЛ МАСАЖ БОНИСИГА МЕДОВИ СКРАБОВНИ  МАСАЖ ВА МОЙКА   ШОШИЛИЛА😘
ЕНДИ СЗ КУТКАН МАСАЖ ТУРЛАРИ ФАК,АТ БИЗДА 

МАССАЖНИНГ ЕНГ СУРПИРИЗЛАРИ  ЕНДИ БИЗДА
💥ЙЕНГИ ОЧИЛГАН СПА САЛОН 
   ХОНАЛАР КОМФОРТ 
   ТАНЛОВДА АДАШМЕ
ХАММА НАРСА АДНОРАЗВИЙ💥

🖤ХУРМАТЛИ ЕРКАКЛАР ЧИРОЙЛИ ВА ХУШ МУОМЛА ЙОШ КИЗЛАР СИЛА УЧУН  2004 2005 🖤 2006🙈
...
КЗЛАНИ ИШКА ОЛАМИЗ ВА ЎРГАТАМИЗ 50/50 
